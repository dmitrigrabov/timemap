...
import Handles from 'components/time/atoms/Handles'
import ZoomControls from 'components/time/atoms/ZoomControls'
...
class Timeline extends Component<TimelineProps> {
  ...
  addEventListeners() {
    ...
    const element = globalThis.document.querySelector('.timeline-wrapper')
    if (element !== null) {
