...
import siteSchema from 'reducers/validate/siteSchema'
import associationsSchema from 'reducers/validate/associationsSchema'
import sourceSchema from 'reducers/validate/sourceSchema'
import regionSchema from 'reducers/validate/regionSchema'
 ...
 */
const makeError = (type: string, id: string, message: string) => ({
  type: 'error',
  id,
 ...
 */
export function validateDomain(domain: DomainState, features: FeaturesState) {
  const sanitizedDomain: DomainState = {
    events: [],
    sites: [],
    associations: [],
    sources: {},
